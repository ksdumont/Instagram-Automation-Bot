...
def follow_users(browser, path_to_file):
    ...
    print(f"You followed {len(users_followed)} users and stored them in 'followed.csv' ")
...
def main():
    ...
    follow_users(browser, '../csv_files/yogaasanatutorial_followers.csv')
